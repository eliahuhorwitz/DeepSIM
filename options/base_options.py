...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='edge2image', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--apply_binary_threshold', type=int, default=1,help='apply binary threshold during augmentation',)
        ...
        self.parser.add_argument('--edge_threshold', type=float, default=0, help='threshold value')
